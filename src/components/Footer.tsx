...
import { ShieldCheck, Mail, Phone, MapPin, Globe, Award, ExternalLink, Send, ArrowRight } from 'lucide-react';
      ...
      <div className="border-b border-slate-800/80">
        <div className="max-w-7xl mx-auto px-4 lg:px-8 py-3.5 flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <span className="px-2.5 py-0.5 bg-amber-500/20 text-amber-300 rounded text-[11px] border border-amber-400/30 font-medium">
